package com.yizhi.android.juhe.utils;
...
public class TestUtil {
    ...
    public static String sendGet(String s) {
        try {
            URL url = new URL(s);    // 把字符串转换为URL请求地址
     ...
     * @return 所代表远程资源的响应结果
     */
    public static void sendPost(CallBack callBack, String url, String param, String charset) {
        ...
        try {
            ...
            if (callBack instanceof CallBack1) {
                ((CallBack1) callBack).onSuccess(sb.toString());
            } else if (callBack instanceof CallBack2) {
                try {
                    ((CallBack2) callBack).onSuccess(QRCodeUtil.createQRCodeBitmap(new JSONObject(sb.toString()).getString("url"), 500, 500));
                } catch (JSONException e) {
                    CLog.log().e("TestUtils", sb.toString(), e);
                }
            }
        } catch (Exception e) {
            callBack.onFail(e);
